...
- [x] **Links dos dashboards** de observabilidade e do vídeo
- [x] Substituir o bloco "TODO (entrega)" do video pelo link final
...
- [x] `docs/user-stories/README.md` (indice das historias por fase/sprint)
